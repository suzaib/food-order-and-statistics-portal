...
//   Fetch orders data
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/vendorhistory?brand=${brand}`); // Assuming endpoint to fetch orders
  ...
  return (
    <div className={styles.mainContainer}>
      <h1 className={styles.title}>Order Statistics for : {brand}</h1>
